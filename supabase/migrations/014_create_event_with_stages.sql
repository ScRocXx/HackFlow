-- 014_create_event_with_stages.sql
-- Atomic PostgreSQL RPC transaction for event creation with stages, deliverables, resources, and participants
-- Eliminates partial failure states and collapses 7 sequential HTTP roundtrips into 1 atomic database call.
