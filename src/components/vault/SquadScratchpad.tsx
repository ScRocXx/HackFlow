        ...
        <div className="space-y-5">
          ...
          <Card className="border-2 border-[#10201d] bg-[#f7f7f2] shadow-[5px_5px_0_#671912]">
            ...
            <CardContent className="p-4 space-y-4">
              ...
              {/* Test Logins / Judge Credentials */}
              <div className="space-y-1.5">
                <div className="flex items-center justify-between">
                  <label className="font-mono text-xs font-bold uppercase text-[#10201d] flex items-center gap-1.5">
                    <Key className="w-3.5 h-3.5 text-[#f5b726]" />
                    <span>Test Accounts & Passwords (Judge / Demo Logins)</span>
                  </label>
                  {formData.test_credentials && (
                    <Button
                      ...
                      className="h-6 text-[10px] font-mono font-bold bg-[#f5b726] hover:bg-[#ffcf66] text-[#10201d] border border-[#10201d]"
                    >
                ...
                <textarea
                  ...
                  rows={4}
                  placeholder={`Admin: admin@hackflow.dev / pass123\nJudge: judge@hackathon.org / review2026\nAPI Token: Bearer demo_token_xyz`}
                  className="w-full p-2.5 font-mono text-xs border-2 border-[#10201d] bg-white shadow-[2px_2px_0_#10201d] focus:outline-none resize-none leading-relaxed"
                />
              </div>
            </CardContent>
          </Card>
